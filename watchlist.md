...
**Scoring Source**: SuperGrok-Alpha Advanced Fundamental Module + J-Curve v1.2 + Capability Moat overlay  
**Lens**: Manufacturing | Precision Engineering | Power Equipment | Defence | Pharma Devices | Specialty Chemicals

---

## Ranked Watchlist

| Rank | Company | Theme | Conviction (/10) | Key Monitorables / Notes | Best Entry Zone |
|------|---------|-------|------------------|---------------------------|-----------------|
| 1 | **Azad Engineering** | Precision Engg + Aerospace/Defence | **8.2** | High entry barriers, global OEM stickiness, strong order visibility. Capacity absorption & mix shift key. | On dips |
...
| 22 | **Advait Energy** | Power T&D + BESS | **6.8** | Monitor execution on BESS / green hydrogen. | On dips |
| 23 | **Accent Microcell** | Microcrystalline Cellulose | **6.7** | Leading MCC manufacturer. Strong exports + premium mix shift. | On dips |
| 24 | **Metalic Technoforge** | Precision Forging & Machining | **6.4** | Closed-die forging + machining. ~35% exports. Capacity expansion. | On dips |
| 25 | **Aimtron Electronics** | EMS / Electronics | **6.3** | Growth EMS. Competitive space. | On dips |

---

## Newly Embedded from Aug 2026 Focused Scan

**Sectors Targeted**: Manufacturing | Precision Engineering | Power Equipment | Defence | Pharma | Specialty Chemicals  
**Horizon**: Next 12–18 months (FY27 focus)

| Company | Why Added | Priority Tier |
|---------|-----------|---------------|
...
### Azad Engineering
1. Capacity utilisation and absorption of new capacity
2. Mix shift toward higher-value aerospace/defence components
3. Global OEM order conversion and stickiness
4. Margin trajectory with scale
...
2. IR optics volume ramp
3. Overall order book quality and visibility

### Shaily Engineering Plastics
1. New drug delivery device commercialisation
2. Margin expansion with higher-value mix
3. Qualification pipeline progress
